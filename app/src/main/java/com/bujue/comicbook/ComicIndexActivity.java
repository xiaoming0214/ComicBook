 ...
 * @date 16/4/15
 */
public class ComicIndexActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.comic_index);
        mToolBar = (Toolbar) this.findViewById(R.id.toolbar);
        mRecyclerView = (RecyclerView) this.findViewById(R.id.comic_index_listview);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_comic_index, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.comic_search) {
            Intent intent = new Intent(ComicIndexActivity.this, ComicSearchActivity.class);
    ...
    public class IndexAdapter extends RecyclerView.Adapter<IndexAdapter.MyHolder> {
        ...
        public void onBindViewHolder(MyHolder holder, int position) {
            ...
            Glide.with(ComicIndexActivity.this).load(imageUrl).into(holder.imageView);
            ...
            holder.imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(ComicIndexActivity.this, ComicPreviewActivity.class);
